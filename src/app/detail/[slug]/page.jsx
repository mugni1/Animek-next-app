...
import TitleAndText from "@/components/ui/detail/TitleAndText";
    ...
    <Container>
      <section className="w-full flex flex-col gap-4">
        ...
        <div className="w-full grid grid-cols-2 gap-5 justify-center">
          <button
            className={`columns-1 py-2 px-3 rounded-full font-semibold text-white ${
              anime.details.Status == "Completed"
                ? "bg-red-600"
                : "bg-green-600"
            }`}
          >
        ...
        {/* synops  */}
        <TitleAndText title={"Sinopsis"} text={anime.description}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        {/* studio  */}
        <TitleAndText title={"Studio"} text={anime.details.Studio}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        {/* season  */}
        <TitleAndText title={"Season"} text={anime.details.Season}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <TitleAndText
          title={"Duration"}
          text={anime.details?.Durasi || "Unknown"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        {/* Episode  */}
        <TitleAndText title={"Episode"} text={anime.details.Episode}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
